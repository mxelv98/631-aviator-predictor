...
const FeatureCard: React.FC<FeatureCardProps> = ({ title, description, image }) => {
  return (
    <article className="bg-white border-[3px] border-black rounded-xl shadow-hard p-10 flex flex-col items-center text-center h-full transition-transform hover:-translate-y-1">

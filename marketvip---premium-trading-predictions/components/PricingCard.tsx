...
import { RIGHT_FEATURES, LEFT_FEATURES } from '../constants';
...
const PricingCard: React.FC<PricingCardProps> = ({ onSubscribe }) => {
  ...
  return (
    <div className="w-full max-w-2xl bg-white border border-gray-100 rounded-[32px] overflow-hidden shadow-2xl transition-all duration-300 transform hover:scale-[1.01]">
      {/* Header */}
